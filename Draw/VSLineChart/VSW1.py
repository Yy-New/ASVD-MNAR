...
def draw_line(gamma_prop_files_path, gamma_prop_files, threshold_concentration_file, file, save_path):
    ...
    for i in range(3):
        for j in range(4):
            ...
            data = pd.read_excel(result_path, index_col=0)

            data = data.loc[['ASVD-MNAR_11', 'ASVD-MNAR_12', 'ASVD-MNAR_13', 'ASVD-MNAR_14', 'ASVD-MNAR_15','ASVD-MNAR_16', 'ASVD-MNAR']]

            x_values = data.columns.values

            markers = ['o', '^', 's', 'd', '*', 'p', 'h', 'o', '^', 's', 'd', '*', 'p', 'h']
            line_styles = ['-', '--', ':', '-.', (0, (1, 1)), (0, (5, 5)), (0, (10, 1)), '-', '--', ':', '-.', (0, (1, 1)), (0, (5, 5)), (0, (10, 1)),]
    ...
    fig.legend(handles, labels_legend, loc='upper center', ncol=len(labels_legend), fontsize=12, frameon=False, bbox_to_anchor=(0.5, 0.97))

    tmp_path = f'{save_path}/vs_svd'
...
file_path = "../../AverageResults/NRMSE/ASVDImputation"
